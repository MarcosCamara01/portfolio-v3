export const metadata = {
  ...
  description: "Some tips on how to make your Next.js application have a better performance and a better UX",
  openGraph: {
    title: "Get the Best Performance on Your Next.js App",
    description: "Some tips on how to make your Next.js application have a better performance and a better UX",
    images: [{ url: '/og/F8TUX3gHu4566g.webp' }],
  }
}
...
![DevTools tab in Google to see your unused files](/images/get-the-best-performance-on-nextjs-app/5FQYp9DjKGOQ.webp)
...
![loading.js overview](/images/get-the-best-performance-on-nextjs-app/QhxJsVosZAJmCknJPA.webp)
...
![next/bundle-analyzer package example](/images/get-the-best-performance-on-nextjs-app/J7pWirYAvc2Q.webp)
