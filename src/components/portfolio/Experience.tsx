    ...
    <section className="space-y-6">
      ...
      <div className="bg-foreground border border-border rounded p-6 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <P className="mb-6 text-sm text-muted-foreground">
          Part of the team developing a product to optimize legal practice,
          covering the full development cycle and using the latest technologies.
          I apply advanced knowledge in React, Next.js, Node.js, and Python.
          Currently studying engineering in AI, Machine Learning, and Deep
          Learning to connect these fields with my software development skills.
        </P>
